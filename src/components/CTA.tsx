    ...
    >
      <div className="container relative z-10 text-center">
        ...
        >
          <a
            onClick={onOpenModal}
            className="cursor-pointer inline-flex items-center gap-2 bg-white text-ocean-700 px-7 py-3 rounded-xl font-semibold shadow hover:bg-gray-100 transition"
          >
